...
data1 = pd.read_csv("datasetmovies.csv", usecols=['original_title','genres','overview','belongs_to_collection'])
datacast=pd.read_csv("credits.csv", usecols=['cast'])
...
'''def findPoster(title):
    ...
    detailsList = requests.get(url=r'http://www.omdbapi.com/?i=tt3896198&apikey=54ffcd09={title}')
	print(detailsList)
